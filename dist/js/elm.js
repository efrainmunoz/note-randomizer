...
var _user$project$Model$Note = F2(
	function (a, b) {
...
var _user$project$Model$G = {ctor: 'G'};
var _user$project$Model$F = {ctor: 'F'};
var _user$project$Model$E = {ctor: 'E'};
var _user$project$Model$D = {ctor: 'D'};
var _user$project$Model$C = {ctor: 'C'};
var _user$project$Model$Natural = {ctor: 'Natural'};
var _user$project$Model$defaultNote = A2(_user$project$Model$Note, _user$project$Model$C, _user$project$Model$Natural);
...
var _user$project$Messages$RandomNote = {ctor: 'RandomNote'};
var _user$project$Messages$NewNote = function (a) {
...
var _user$project$Utilities$bgColor = A2(
	_elm_lang$core$Random$map,
...
var _user$project$Utilities$nameMapping = function ($int) {
	...
	switch (_p1) {
		...
		case 2:
			return _user$project$Model$D;
		case 3:
			return _user$project$Model$E;
		case 4:
			return _user$project$Model$F;
		case 5:
			return _user$project$Model$G;
		case 6:
			return _user$project$Model$A;
		default:
			return _user$project$Model$B;
	}
};
var _user$project$Utilities$name = A2(
	_elm_lang$core$Random$map,
...
var _user$project$Utilities$accidentalMapping = function ($int) {
	...
	switch (_p2) {
		...
		case 2:
			return _user$project$Model$Sharp;
		default:
			return _user$project$Model$Natural;
	}
};
var _user$project$Utilities$accidental = A2(
	_elm_lang$core$Random$map,
	_user$project$Utilities$accidentalMapping,
...
var _user$project$View$footer = A2(
	...
	{
		ctor: '::',
		_0: _user$project$View$instructions,
		_1: {ctor: '[]'}
	});
var _user$project$View$mainArea = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('note-box'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Messages$RandomNote),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('note-name'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.note.name)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('accidental'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_user$project$Utilities$accidentalSymbol(model.note.accidental)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$View$logo = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('NOTE RANDOMIZER'),
		_1: {ctor: '[]'}
	});
var _user$project$View$nav = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('nav flex-row'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: model.bgColor},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$mainArea(model),
				_1: {
					ctor: '::',
